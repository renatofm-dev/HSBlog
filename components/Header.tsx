  ...
  return (
    <header className="flex items-center justify-between space-x-2 font-bold px-10 py-5">
      ...
      >
        ...
        <span className="absolute inset-0 w-full h-full bg-[#001542] rounded-md "></span>
        ...
        <span className="relative text-white transition-colors duration-200 ease-in-out delay-100 group-hover:text-[#001542] ">Contrate Agora</span>
      </Link>
      </div>
